...
const uint32_t DOWNSCALE_FACTOR = 2;
...
const uint32_t STREAMLINE_ITERATIONS = (2000 * 4 / DOWNSCALE_FACTOR);
const uint32_t STREAMLINE_PARTICLES_PER_ROW = (200 / DOWNSCALE_FACTOR);
const uint32_t STREAMLINE_PARTICLES_PER_COL = (STREAMLINE_PARTICLES_PER_ROW / 2);
